function [out, xloc, yloc, dist1to2] = sensorSweep(XY1,XY2)
...
% Arrange output.
out = INT_B;
xloc = INT_X .* INT_B; %out.intMatrixX
yloc = INT_Y .* INT_B; %out.intMatrixY
dist1to2 = u_a; % out.intNormalizedDistance1To2
