...
% plot(rand(10))
costs = 2*[.3 .2 .2 .5 .3 .3 .3 .3 .3 .3 .3 .4 .4 .3 .2;
        .3 .5 .5 .3 .2 .2 .2 .3 .5 .3 .3 .3 .5 .4 .3;
...
P_tr = [.90 .50 .50 .75 .99 .99 .99 .99 .99 .99 .99 .99 .99 .99 .99;
       .90 .50 .50 .99 .99 .99 .99 .90 .75 .99 .99 .99 .99 .99 .99;
       .90 .80 .45 .75 .99 .99 .99 .90 .99 .99 .99 .99 .99 .99 .99;
...
% for i = 1:V
%     v = [ coords(i,2)-0.5 coords(i,1)-0.5; coords(i,2)-0.5 coords(i,1)+0.5; coords(i,2)+0.5 coords(i,1)+0.5; coords(i,2)+0.5  coords(i,1)-0.5 ];
%     patch('Faces', [1 2 3 4], 'Vertices', v, 'FaceColor', [1 0 0 ], 'FaceAlpha', P_tr(i))
% end
% 
% 
% axis off
