...
%     plot(x(1,i), x(2,i), 'k:', x_hat(1,i), x_hat(2,i), 'rx')
    plot_gaussian_ellipsoid([x(1, i), x(2,i)], sqrt(sigma_update(1:2,1:2,i) + lambda(1:2,1:2,i)), 4, 25); % mean, std dev, stdwidth (2~= .86), n points. 
end
...
hold on
plot(t, r, 'k:')
legend('x1' , 'x2', 'x3', 'x4', 'r', 'Location', 'NorthWest')
% figure(3)
% plot(t, x_hat)
% title('x error')
figure(1)