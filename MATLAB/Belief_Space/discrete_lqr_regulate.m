...
%     plot(x(1,i), x(2,i), 'k:', x_hat(1,i), x_hat(2,i), 'rx')
    plot_gaussian_ellipsoid([x(1, i), x(2,i)], sigma_update(1:2,1:2,i) + lambda(1:2,1:2,i), 1, 25); % mean, std dev, stdwidth (2~= .86), n points. 
end
